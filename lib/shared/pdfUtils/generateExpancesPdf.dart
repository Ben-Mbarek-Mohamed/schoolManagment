...
Future<void> generateExpancesPdf(
  ...
  final String title = '${translation(cont).expenses} :   ${translation(cont).total }   ${ammounts?.length ?? 0 }';
                        ...
                        return pw.TableRow(
                          children: [
                            ...
                            bool isArabic = cell.contains(
                                RegExp(r'[\u0600-\u06FF]'));
                            bool isArabic2 = translation(cont).payment_of_teacher.contains(
                                RegExp(r'[\u0600-\u06FF]'));
                            return pw.Container(
                              alignment: pw.Alignment.center,
                              padding: const pw.EdgeInsets.all(8),
                              ...
                              (!isArabic2)?pw.Row(
                                ...
                                children: [
                                  pw.Text(
                                    '${translation(cont).payment_of_teacher} : ',
                                    style: pw.TextStyle(
