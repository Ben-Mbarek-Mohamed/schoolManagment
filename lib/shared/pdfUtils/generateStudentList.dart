...
Future<void> generateStudentsPdf(
  ...
  final String title = '${translation(cont).students} :   ${translation(cont)
                        ...
                        return pw.TableRow(
                          children: [
                            ...
                            student.birthDate != null
                                ...
                                : '',
                            getRequiredAmmount(student,cont).toStringAsFixed(2) ?? '',
                            student.registrationDate != null
                                ? DateFormat('yyyy-MM-dd').format(
                                student.registrationDate!)
                                : '',
                            _getAbsences(student.id!).toString() ?? '',
                          ].map((cell) {
