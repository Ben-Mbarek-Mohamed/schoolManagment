...
Future<void> generateProfsPdf(
  ...
  final ByteData arabicFontData = await rootBundle.load(
      'assets/fonts/NotoSansArabic-Regular.ttf');
  final arabicFont = pw.Font.ttf(arabicFontData);

  // Get the translated title

  final String title = '${translation(cont).profs} :   ${translation(cont)
        ...
        pw.Page(
          build: (pw.Context context) {
            return pw.Padding(
              ...
              child: pw.Column(
                crossAxisAlignment: isTitleArabic
                ...
                children: [
                  ...
                  isTitleArabic ? pw.Row(
                      ...
                      children: [
                        ...
                        pw.Column(
                            crossAxisAlignment: isTitleArabic ? pw
                                .CrossAxisAlignment.end : pw.CrossAxisAlignment
                                .start,
                            children: [
                              pw.Text(
                                ...
                                textDirection: isTitleArabic ? pw.TextDirection
                                    .rtl : pw
                                    .TextDirection.ltr,
                              ),
                              pw.Text(
                        ...
                        return pw.TableRow(
                          children: [
                            ...
                            prof.birthDate != null
                                ...
                                : '',
                            prof.major ?? '',
                            getAmmount(prof, cont).toStringAsFixed(2) ?? '',
                            prof.registrationDate != null
                                ? DateFormat('yyyy-MM-dd').format(
                                prof.registrationDate!)
                                : '',
                            _getAbsences(prof.id!).toString() ?? '',
                          ].map((cell) {
